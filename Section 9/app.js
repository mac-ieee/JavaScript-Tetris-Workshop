...
// in this section, we will add a lose condition and a score 


// ADDSCORE()
// the function ADDSCORE() is used to ... add to the score
// it removes any filled row and adds a set amount to the score
// in this case, every row is worth 10 points
	function addScore() {

	}

// GAMEOVER()
// this function detects when the tetrominoes reaches the top
// it then stops the game and music
// we also need to display a "game over" screen
	function gameOver() {
